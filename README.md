...
services:
  p1-mobile:
    ...
    environment:
      ...
      # optional, cache configuration for downloaded 3MF files
      - CACHE_MODELS_ENABLED=true #if enabled, downloaded 3MF files will be cached to reduce FTP downloads (default: true)
      - CACHE_MAX_AGE_DAYS=7 #number of days to keep cached files before automatic cleanup (default: 7)
