...
export default function TasmotaSwitch() {
  ...
  return (
    <>
      <Box display="flex" alignItems="center" sx={{ bgcolor: 'rgba(255, 255, 255, 0.06)', borderRadius: 100, border: '1px solid rgba(255, 255, 255, 0.08)', mr: 1 }}>
      ...
      >
        <DialogTitle id="tasmota-switch-dialog" sx={{ m: 0, p: 2 }}>
          ...
          <IconButton
            aria-label="close"
            onClick={handleClose}
            sx={{ position: 'absolute', right: 8, top: 8, backgroundColor: 'rgba(255, 255, 255, 0.06)', border: '1px solid rgba(255, 255, 255, 0.1)', '&:hover': { backgroundColor: 'rgba(255, 255, 255, 0.12)' } }}
            size="small"
          >
            <CloseIcon />
          </IconButton>
